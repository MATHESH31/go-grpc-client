...
const (
	Employee_GetEmployee_FullMethodName = "/employee.v1.Employee/getEmployee"
)
...
func (c *employeeClient) GetEmployee(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*EmployeeResponse, error) {
...
func (UnimplementedEmployeeServer) GetEmployee(context.Context, *EmployeeRequest) (*EmployeeResponse, error) {
...
func _Employee_GetEmployee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServer).GetEmployee(ctx, req.(*EmployeeRequest))
	}
